...
여기에 약간의 delay만 추가하면 비행기가 입력에 따라 어떻게 반응하는지 확인하기 쉬워진다.
...
이제 RealFlight Link를 통해 조종 신호를 보내고 그에 대한 상태 응답을 다시 받아오는 **상호작용이 가능한 제어 루프의 출발점**을 갖췄다.  구체적으로 다음 요소들이 준비되었다.
